...
def check_sudoku(grid):
    # your solution here
    grid_ar = string_to_grid(grid)

    return check_sudoku_dimensions(grid_ar) and check_sudoku_rows(grid_ar) and \
           check_sudoku_cols(grid_ar) and check_sudoku_subgrids(grid_ar)
